...
class AuthenticatedMovieApiTests(TestCase):
    ...
    def test_movies_list(self):
        ...
        actor_1 = Actor.objects.create(first_name="Angela", last_name="Faula")
        actor_2 = Actor.objects.create(first_name="David", last_name="Roudes")
    ...
    def test_retrieve_movie_detail(self):
        movie = sample_movie()
        movie.actors.add(Actor.objects.create(first_name="Angela", last_name="Faula"))
